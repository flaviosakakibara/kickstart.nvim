...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'bash', 'markdown', 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'javascript', 'typescript', 'vimdoc', 'vim', 'json', 'yaml' },
...
obsidian.setup {
  ...
  dir = "/Users/fsakakib/Git/code.amazon.com/FsakakibObsidianNotes/src/FsakakibObsidianNotes/personal_vault/",
